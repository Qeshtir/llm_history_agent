...
logging.basicConfig(
    level=logging.INFO
)  # Установите уровень логирования на INFO или DEBUG
...
def test_load_documents_from_directory(rag_service):
    ...
    results = rag_service.chroma_service.query_documents(
        collection_name=collection_name, query_text="тестовый", n_results=20
    )
